...
setContentView(R.layout.activity_main); dbHelper = new DBHelper(this);
...
@Override public void onClick(View v) {
int rollNo = Integer.parseInt(editTextRollNo.getText().toString()); dbHelper.deleteStudent(rollNo);
